...
-- Insert 150 fuel entries with realistic data (3 entries per vehicle)
...
WHERE v.VehicleId <= 50  -- Ensure we only use 50 vehicles
...
PRINT 'Total entries created: 150 (3 entries per vehicle)';
